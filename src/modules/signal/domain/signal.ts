...
export namespace Signal {
    ...
    export namespace DataLength {
        ...
        export const is = (value : number) :value is DataLength =>  typeof value === "number" && value >= 0;
    ...
    export namespace DataVolume {
        ...
        export const is = (value : number) :value is DataVolume =>  typeof value === "number" && value >= 0;
 ...
 const signalSchema = z
    .object({
        ...
        deviceId: z.string().refine(NonEmptyString.is, { message: 'Invalid deviceId' }),
